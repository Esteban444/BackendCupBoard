...
namespace ProductManagment.Core.Services
{
    public class AuthService : IAuthService 
    {
        ...
        public AuthService(UserManager<ApplicationUser> userManager, IMapper mapper,ISettingsRepository settingsRepository)
        {
        ...
        public async Task<RegisterResponseDto> RegisterUser(RegisterRequestDto registerUser)
        {
        ...
        private async Task<AuthResponseDto> GenerateToken(LoginRequestDto authentication)
        {
